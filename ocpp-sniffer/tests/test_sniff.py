...
class TestAvailableResetsChargingEnabled:
    def setup_method(self):
        _reset()

    def test_available_resets_charging_enabled(self):
    ...
    def test_available_noop_when_already_disabled(self):
        main_mod._charging_enabled = False
        msg = json.dumps(
            [
                2,
    ...
    def test_preparing_does_not_reset_charging_enabled(self):
        main_mod._charging_enabled = True
        msg = json.dumps(
            [
                2,
    ...
    def test_charging_status_returns_charging_when_disabled(self):
        main_mod._charging_enabled = False
        msg = json.dumps(
            [
                2,
    ...
    def test_charging_status_no_signal_when_enabled(self):
        main_mod._charging_enabled = True
        msg = json.dumps(
            [
                2,
